            ...
            <div>
              <div className="text-xl md:text-5xl mb-2 hidden sm:block">
                ...
                <Typist
                  ...
                  typingDelay={110}
                  loop={true}
                  cursor={<span className="cursor">{this.state.cursor}</span>}
                >
                  nonymous Chat Room <Typist.Delay ms={1500} />
                  <Typist.Backspace count={18} />
                </Typist>
              </div>
              <div className="text-xl md:text-5xl mb-2 block sm:hidden">Anonymous Chat Room</div>
            </div>
          ) : (
            <div className="text-xl md:text-5xl mb-2 block">欢迎使用 CSSC 视频会议系统</div>
          )}
